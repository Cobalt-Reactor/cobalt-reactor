...
impl GridAxis {
    ...
    pub const fn new_rgb() -> Self {
        Self {
            x: Some(Color::Srgba(tailwind::RED_700)),
            y: Some(Color::Srgba(tailwind::GREEN_700)),
            z: Some(Color::Srgba(tailwind::BLUE_700)),
        }
    }
    ...
    /// Returns a vector of used axis with their corresponding color, as well as a vector of unused
    /// axis, `(used, unused)`.
