...
/// `WeightedTable`
///
/// This is a simple implementation of a weighted table. It is designed to be used with a random
/// number generator. It can be used as follows:
///
/// ```rust
/// use reactor_random::prelude::{WeightedTable, RandomContainer};
///
...
///
/// ```rust
/// use reactor_random::prelude::WeightedTable;
///
/// let mut table = WeightedTable::new();
///
