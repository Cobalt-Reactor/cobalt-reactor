...
impl Radians {
    /// Create a new `Radians`
    pub fn new(radians: f32) -> Self {
        Self::from_f32(radians)
    }

    /// Returns the angle in radians as an `f32`
    pub fn to_f32(self) -> f32 {
        self.0
    }

    fn from_f32(angle: f32) -> Self {
        Self(angle)
    }

    /// Returns the angle in degrees as an `f32`
