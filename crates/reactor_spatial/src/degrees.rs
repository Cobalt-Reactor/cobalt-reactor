...
impl Degrees {
    ...
    /// Create a new `Degrees` from an `f32`
    ...
    /// A Degrees representing Up in 2D
    pub const UP: Self = Self(90.);
    /// A Degrees representing Down in 2D
    pub const DOWN: Self = Self(-90.);
    /// A Degrees representing Left in 2D
    pub const LEFT: Self = Self(180.);
    /// A Degrees representing Right in 2D
