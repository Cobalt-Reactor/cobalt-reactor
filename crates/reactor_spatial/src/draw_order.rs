...
/// A struct representing the draw order of an entity
/// Higher draw orders will be drawn on top of lower draw orders
...
impl DrawOrder {
    ...
    /// Returns a new `DrawOrder` from an `f32`
    fn from_f32(order: f32) -> Self {
        Self::new(order)
    }
}
